...
DATA_DIR = os.getenv('server_DATA_DIR', PROJECT_ROOT)
WEBROOT_DIR = os.getenv('server_WEBROOT_DIR', os.path.join(PROJECT_ROOT, 'webroot/'))

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv('server_SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('server_DEBUG_IN_PRODUCTION', 'False') == 'True'
...
DATABASES = {
    'default': {
        'ENGINE': os.getenv('server_DB_ENGINE',
                            'django.db.backends.sqlite3'),
        'USER': os.getenv('server_DB_USER', 'server'),
        'PASSWORD': os.getenv('server_DB_PASSWORD', 'password'),
...
if DATABASES['default']['ENGINE'] == 'django.db.backends.sqlite3':
    DATABASES['default']['NAME'] = os.getenv('server_DB_PATH',
                                             os.path.join(DATA_DIR, 'db.sqlite3'))
else:
    DATABASES['default']['NAME'] = os.getenv('server_DB_NAME', 'server')
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.getenv('server_GOOGLE_OAUTH2_KEY')
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.getenv('server_GOOGLE_OAUTH2_SECRET')
...
STATIC_URL = os.getenv('server_STATIC_URL', '/static/')
